...
if (!function_exists('current_platform')) {
    function current_platform()
    {
        ...
        $platform = resolve('current_platform');
...
if (!function_exists('localized_route')) {
    function localized_route($url = null, $attributes = [], $locale = null)
    {
...
if (!function_exists('clean_string')) {
    ...
    {
        $excluded = array("á", "é", "í", "ó", "ú", "Á", "É", "Í", "Ó", "Ú", "À", "Ã", "Ì", "Ò", "Ù",);
        $enabled = array("a", "e", "i", "o", "u", "A", "E", "I", "O", "U", "A", "A", "I", "O", "U");
        $string = str_replace($excluded, $enabled, $string);
...
if (!function_exists('debug_query_sql')) {
    function debug_query_sql($query)
    {
        $sql = $query->toSql();
